# Copilot Instructions — super-assistant

Guidance for AI coding agents working in this repository. Follow these conventions and the spec-driven workflow below.
